...
/// Run100 홈 화면 바탕화면 Medium(2x4) 단일 규격 위젯 정의
struct Run100Widget: Widget {
    let kind: String = "Run100Widget"
...
#Preview(as: .systemMedium) {
    ...
    SimpleWidgetEntry(date: .now, data: .placeholder)
}
